...
c.execute("CREATE TABLE IF NOT EXISTS leaderboard(userID INTEGER PRIMARY KEY AUTOINCREMENT, wins INTEGER)")
...
#c.execute("INSERT INTO leaderboard (wins) VALUES(?)",(234,))
...
#c.execute("INSERT INTO leaderboard (wins) VALUES(?)",(34,))
